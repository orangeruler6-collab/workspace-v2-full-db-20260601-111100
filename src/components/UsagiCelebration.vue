...
const detailByKind = {
  handoff: ['有新任务交到你手里了，先别慌，乌萨奇帮你盯住。', '叮！新订单落地，先看账号和要求。', '新的小纸条飘过来了，先接住。', '任务入口亮了，乌萨奇把灯打开。'],
  'task-done': ['完成得很漂亮，工位小兔原地弹起。', '这一格清掉了，班味被击退一点。', '啪嗒，任务盖章通过。', '好耶，今天的进度条又长了一截。'],
  generate: ['资料翻完了，先看结果，不满意我们再咬一口。', '脑袋转到冒烟，但东西拿回来了。', '灵感锅咕嘟咕嘟，出锅啦。', 'AI 小铲子挖到东西了，快看。'],
  publish: ['发布流程开跑，乌萨奇坐在副驾驶盯着。', '小车挂好，准备把内容送出去。', '账号、视频、文案，乌萨奇逐个点名。', '这条开始出门营业啦。', '先稳住节奏，一条一条送到位。'],
  queue: ['队列已经排好，等时间一到就出发。', '排队小本本写好了，乌萨奇守着点。', '后面的任务先站好队，不抢跑。', '定时小闹钟上好了，到点提醒。'],
  pause: ['暂停收到，先让电脑喘口气。', '已按住刹车，队列不会继续往前冲。', '乌萨奇把小车停稳了。', '先停在这里，等你说继续。'],
  retry: ['没事，乌萨奇帮你重新跑一遍。', '第一次磕了一下，再来一次。', '换个姿势继续试，别急。', '重试小旗举起来了。'],
  upload: ['视频在路上，乌萨奇盯着进度条。', '正在搬视频，别催它，它有点重。', '上传通道亮着，等它落地。', '大文件慢一点也正常，我帮你看着。'],
  login: ['账号门牌确认中，别跑错家。', '登录态探头看一眼，确认是这个号。', '先认门，再干活。', '乌萨奇在核对账号小名牌。'],
  check: ['我探头看一下页面状态。', '这里先确认一下，再往下点。', '乌萨奇正在检查按钮有没有醒。', '等页面站稳，我们再动手。'],
  material: ['素材收到了，放进篮子里。', '视频小包裹入库啦。', '素材已经排队，别混号。', '这份材料先贴好标签。'],
  delete: ['清掉了，桌面清爽一点。', '这条已经移走，不占地方。', '乌萨奇扫了一下灰。', '不用的东西先收走。'],
  refresh: ['重新捋一遍，别让页面发懵。', '刷新一下脑袋，继续。', '页面重新站好队了。', '状态重抓中，乌萨奇眯眼看。'],
  save: ['放好了，不会偷偷跑掉。', '已收纳，桌面瞬间顺眼一点。', '保存成功，给它贴个小标签。', '资料落袋，稳。'],
  favorite: ['这条有点香，先收藏起来。', '灵感被抱走，之后还能再翻出来。', '先别放跑它，收藏！', '这条值得留一手。'],
  copy: ['已经复制好，贴出去就行。', '剪贴板已塞满，轻拿轻放。', '复制完成，手里有货。', '文字小包裹已经打好。'],
  warning: ['先停半拍，这里可能要确认一下。', '乌萨奇拽住你一下，别急着冲。', '黄灯亮了，先看清楚。', '这里有点晃，慢一点更稳。'],
  error: ['这里卡了一下，不是你的问题，我们继续抓。', '呜哇，撞墙了，但还能修。', '先别急，错误已经露头了。', '乌萨奇摔了一跤，但爬起来了。', '这一步没过，我们把原因揪出来。'],
  success: ['这一小步过了，继续推进。', '可以，工作台回血一点。', '稳稳通过，乌萨奇点头。', '漂亮，这格亮了。', '小胜利到账。'],
  info: ['收到，我在旁边看着。', '嗯哼，先记下。', '小提示冒泡，别漏看。', '乌萨奇在右下角举牌。']
}
